...
namespace parser
{
    namespace json
    {
        ...
        //! When we use ``class array_`` we say to the compiler that we didnt define ``array_`` yet but we will define it later. Without ``class`` keyword the compiler will crash because this class is incomplete 
